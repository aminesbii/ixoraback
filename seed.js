...
async function main() {
  ...
  for (const productData of productSeedData) {
    const categoryKey =
      productData.slug.includes("argan") || productData.slug.includes("shampoo") || productData.slug.includes("elixir") || productData.slug.includes("leave-in") || productData.slug.includes("conditioner")
        ? "haircare"
